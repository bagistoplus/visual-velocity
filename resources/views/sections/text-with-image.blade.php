    ...
    <div class="{{ $mobileAlignClass }} {{ $contentAlignClass }} content flex w-full max-w-md flex-col gap-4 md:mt-0 md:w-1/2 md:gap-5">
      @foreach ($section->blocks as $block)
        @switch($block->type)
          ...
          @case('body')
            <div class="text-lg text-neutral-400" {{ $block->liveUpdate()->html('content') }}>
          ...
          @case('button')
            <a
              ...
              class="rounded-lg bg-primary px-8 py-4 font-semibold text-white hover:opacity-90 md:rounded-xl"
