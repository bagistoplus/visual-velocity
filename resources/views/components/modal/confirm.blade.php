            ...
            >
                ...
                >
                    <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        <div class="absolute left-1/2 top-1/2 z-[999] w-full max-w-[475px] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-xl bg-background p-5 max-md:w-[90%] max-sm:p-4">
                            <div class="flex gap-2.5">
                                <div>
                                    <span class="flex rounded-full border border-on-background/10 p-2.5">
                                ...
                                <div>
                                    ...
                                    <div class="pb-5 pt-1.5 text-left text-sm text-on-background/50">
                                        @{{ message }}
                                    </div>
