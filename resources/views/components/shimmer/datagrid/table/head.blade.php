...
@if (!$isMultiRow)
    <div class="row grid grid-cols-6 items-center gap-2.5 border-b bg-background px-6 py-4">
        <!-- Mass Actions -->
...
@else
    <div class="row tems-center grid grid-cols-[2fr_1fr_1fr] items-center gap-2.5 border-b px-6 py-4">
        <!-- Mass Actions -->
