<div class="panel-side journal-scroll grid max-h-[1320px] min-w-[342px] max-w-[400px] grid-cols-[1fr] overflow-y-auto overflow-x-hidden max-xl:min-w-[270px] ltr:pr-7 rtl:pl-7">
    <div class="flex h-[50px] items-center justify-between border-b py-2.5 max-md:hidden">
    ...
    <div class="border-b">
        ...
        <div class="z-10 rounded-lg bg-background">
    ...
    <div class="border-b">
        ...
        <div class="z-10 grid gap-1 rounded-lg bg-background pb-3">
