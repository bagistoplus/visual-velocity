<div v-if="isMediaLoading" class="overflow-hidden 1180:hidden">
    <div class="shimmer aspect-square max-h-screen w-screen bg-surface-alt"></div>
</div>

<div v-else class="scrollbar-hide flex w-screen gap-8 overflow-auto max-sm:gap-5 1180:hidden">
    <v-product-carousel :options="[
        ...media.images,
        ...media.videos
