    ...
    >
        <div class="mb-7 max-md:mb-0">
            ...
            <template v-else>
                ...
                <x-shop::accordion class="overflow-hidden !border-b-0 max-md:rounded-lg max-md:!border-none max-md:!bg-surface">
                        ...
                        <div class="flex flex-wrap gap-8 max-md:gap-4 max-sm:gap-2.5">
                            <template v-for="method in methods">
                                ...
                                >
                                    ...
                                    <label
                                        class="block cursor-pointer rounded-xl border p-5 max-sm:flex max-sm:gap-4 max-sm:rounded-lg max-sm:px-4 max-sm:py-2.5"
                                        :for="rate.method"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-2.5 text-xs font-medium max-md:mt-1 max-sm:mt-0 max-sm:font-normal max-sm:text-on-background/70">
