...
>
    ...
    <div class="container mt-8 px-[60px] max-lg:px-8">
        <div class="grid place-items-center gap-y-5 max-md:gap-y-2.5">
            ...
            <p class="text-xl text-on-background/70 max-md:text-center max-md:text-xs">
            ...
            <a href="{{ route('shop.home.index') }}">
                <div
                    class="w-max cursor-pointer rounded-2xl bg-navyBlue px-11 py-3 text-center text-base font-medium text-on-background max-md:rounded-lg max-md:px-6 max-md:py-1.5">
