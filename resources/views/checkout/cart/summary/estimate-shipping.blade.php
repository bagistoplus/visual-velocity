...
<x-shop::accordion class="overflow-hidden rounded-xl border max-md:rounded-lg max-md:!border-none max-md:!bg-surface" :is-active="false">
    ...
    <x-slot:content class="p-4 pt-0 max-md:rounded-t-none max-md:border max-md:border-t-0 max-md:pt-4">
        <v-estimate-tax-shipping :cart="cart" @processed="setCart"></v-estimate-tax-shipping>
    </x-slot>
</x-shop::accordion>
    ...
    <script type="text/x-template" id="v-estimate-tax-shipping-template">
        ...
        >
            <form @change="handleSubmit($event, estimateShipping)">
                ...
                <div
                    class="mt-4 grid rounded-xl border "
                    v-if="methods.length"
                >
                    <template v-for="method in methods">
                        ...
                        <div
                            class="relative select-none border-b  last:border-b-0 max-md:max-w-full max-md:flex-auto"
